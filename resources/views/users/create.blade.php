...
<div class="row justify-content-center">
    <div class="col-lg-6">
        <div class="mb-4">
            ...
            <p class="text-muted">Create a new user account with credentials</p>
        </div>
            ...
            <div class="card-body p-4">
                <form method="POST" action="{{ route('users.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="name" name="name" class="form-control form-control-lg @error('name') is-invalid @enderror" value="{{ old('name') }}" required placeholder="John Doe">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" id="email" name="email" class="form-control form-control-lg @error('email') is-invalid @enderror" value="{{ old('email') }}" required placeholder="user@example.com">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" id="password" name="password" class="form-control form-control-lg @error('password') is-invalid @enderror" required placeholder="Min 8 chars: 1 upper, 1 lower, 1 number, 1 symbol">
